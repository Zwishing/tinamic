...
//}
//
//func (config *Config) GetMinioConfig() *storage.MinioConfig {
//	return config.minio
//}
//
//func (config *Config) setMinioConfig() {
//	config.minio = &storage.MinioConfig{
...
//	}
//}
//func (config *Config) setRedisConfig() {
//	config.redis = &cache.RedisConfig{
//		Host:     config.GetString("database.redis.host"),
//		Port:     config.GetInt("database.redis.port"),
//		Username: config.GetString("database.redis.user"),
//		Password: config.GetString("database.redis.password"),
//		Database: config.GetInt("database.redis.database"),
//		PoolSize: config.GetInt("database.redis.poolMaxConns"),
//	}
//}
//
//func (config *Config) GetRedisConfig() *cache.RedisConfig {
//	return config.redis
//}
